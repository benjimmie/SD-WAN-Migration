...
:MENU
ECHO ===============================================
ECHO  Hydra Circuit Upload Bandwidth Test
...
.\iperf\iperf3.exe -c 10.42.128.30 -u -t 300 -b %bwK%K -T %bwK% | .\gnuwin\grep.exe "datagrams" -B 3 | .\gnuwin\tee.exe -a ULSDWANTest.log
